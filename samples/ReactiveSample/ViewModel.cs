...
internal static class ViewModel
{
    ...
    public static RootVM Create(StpItem stpItem)
    {
        ...
        else if (stpItem is StpTask stpTask)
        {
            return new TaskVM(stpTask);
        }
        return null;
    }
}
...
internal class SymbolVM : RootVM
{
    ...
    public SymbolVM(StpSymbol stpSymbol)
    {
        ...
        Alternates = stpSymbol.Alternates;
...
/// </summary>
[Category("Task")]
internal class TaskVM : RootVM
{
    protected StpTask _stpTask;
    ...
    public TaskVM() { }
    public TaskVM(StpTask stpTask)
    {
        _stpTask = stpTask;
        Type = "task";
        Id = stpTask.Poid;
        Description = stpTask.Description;
        Alternates = stpTask.Alternates;
        Who = stpTask.Who;
        How = stpTask.How;
        What = stpTask.What;
        Why = stpTask.Why;
    ...
    public override StpItem AsStpItem()
    {
        ...
        _stpTask.What = What;
        _stpTask.Why = Why;
        _stpTask.StartTime = StartTime;
        _stpTask.EndTime = EndTime;
        return _stpTask;
    }
}
