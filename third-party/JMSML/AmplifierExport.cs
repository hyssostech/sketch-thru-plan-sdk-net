...
namespace JointMilitarySymbologyLibrary
{
    public class AmplifierExport
    {
                                                ...
                                                LibraryStandardIdentityGroup identityGroup)
        {
            ...
            string result = string.Empty; //"Amplifier" + _configHelper.DomainSeparator;  //Removed because thought to be redundant
                             ...
                             LibraryStandardIdentityGroup identityGroup)
        {
            ...
            if (amplifierGroup is not null && amplifier is not null)
