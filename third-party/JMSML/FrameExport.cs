...
namespace JointMilitarySymbologyLibrary
{
    public class FrameExport
    {
        ...
        protected string BuildFrameCode(LibraryContext context, LibraryStandardIdentity identity, LibraryDimension dimension, LibraryStatus status, bool asAnyCivilian)
        {
            ...
            if (context is not null && dimension is not null && status is not null)
            {
                                            ...
                                            bool asAnyCivilian)
        {
            ...
            if (dimension.SymbolSets is not null)
            {
            ...
            if(_configHelper.Librarian.Affiliation(context.ID, dimension.ID, identity.ID).Graphic is not null)
                result = result + "Point;";
            else
