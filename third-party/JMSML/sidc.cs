...
namespace JointMilitarySymbologyLibrary
{
    public class SIDC
    {
        ...
        public static SIDC INVALID = new(_specialPartA, _invalidPartB);
        public static SIDC RETIRED = new(_specialPartA, _retiredPartB);
        ...
        public string PartAString
        {
            get
            {
                return this._first10.ToString("D10");
            }
        ...
        public string PartBString
        {
            get
            {
                return this._second10.ToString("D10");
            }
