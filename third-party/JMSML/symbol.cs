...
namespace JointMilitarySymbologyLibrary
{
    ...
    public class Symbol
    {
        ...
        private SIDC _sidc = new();
        private string _legacySIDC;

        private Dictionary<string,string> _names = new();

        private string _tags = "";
        private List<Dictionary<string, string>> _labels = new();
        private Dictionary<string, string> _drawRule = new();
        private string _drawNote = "";

        private ConfigHelper _configHelper;
        private List<string> _graphics = new();
        ...
        public List<string> LegacySIDCs
        {
            get
            {
                ...
                if (_legacySymbol is not null)
                {
                    if (_legacySymbol.LegacyFunctionCode is not null)
                    {
        ...
        public IconType IconType
        {
            get
            {
                ...
                if (_entitySubType is not null)
                    icon = _entitySubType.Icon;
                else if (_entityType is not null)
        ...
        private void _BuildGraphics()
        {
            ...
            if (_sig is not null && _amplifierGroup is not null && _amplifier is not null)
            {
                if (_amplifier.Graphics is not null)
                {
            ...
            if (_sig is not null && _hqTFDummy is not null)
            {
                if (_hqTFDummy.Graphics is not null)
                {
            ...
            if (_status is not null && _dimension is not null && _sig is not null)
            {
                if (_status.Graphics is not null)
                {
                    graphic = "";
                    ...
                    else if (_status.Graphic is not null)
                    {
        ...
        private void _BuildTags()
        {
            ...
            if(_standardIdentity is not null)
            {
        ...
        private void _BuildSIDC()
        {
            ...
            if (_version is not null && _context is not null &&
               _standardIdentity is not null && _symbolSet is not null && _status is not null &&
               _hqTFDummy is not null && _amplifierGroup is not null && _amplifier is not null)
            {
        ...
        private string _BuildLegacySIDC(LegacyFunctionCodeType functionCode)
        {
            ...
            if (_symbolSet is not null && _affiliation is not null && _dimension is not null &&
               _status is not null && _amplifierGroup is not null && _amplifier is not null && _context.ContextCode != 2)
            {
        ...
        private void _UpdateFromCurrent()
        {
            ...
            if (_context is not null && _dimension is not null && _standardIdentity is not null)
            {
            ...
            if (_amplifierGroup is not null)
            {
        ...
        private void _UpdateFromLegacy()
        {
            ...
            if (_legacySymbol is not null)
            {
                string legacyAffiliation = _legacySIDC.Substring(1, 1);
                // Convert unspecified to Pending
                if (legacyAffiliation == "-")
                    legacyAffiliation = "P";
                _affiliation = _librarian.AffiliationByLegacyCode(legacyAffiliation, _dimension.ID);
